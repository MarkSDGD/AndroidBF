package com.mark.uibox.powerfulrecyclerview;
...
import com.mark.uibox.CalculateTool;
import com.mark.uibox.R;
...
public class PowerfulRecyclerView extends RecyclerView {
    ...
    public PowerfulRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        mDividerSize = ta.getDimensionPixelSize(R.styleable.PowerfulRecyclerView_dividerSize, CalculateTool.dip2Px(context,1));
